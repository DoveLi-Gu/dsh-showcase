...
const messages = {
  zh: {
    ...
    legend: "海报风格",
    field: "边境信号",
    fieldHint: "工业秩序、灰白材料与荧光信号色。",
    fish: "蓝色大肥鱼",
    fishHint: "明亮钴蓝、白色底面与鲸鱼娘社区气质。",
    saving: "正在保存…",
    saved: "已保存，下一次调用生效。",
    failed: "保存失败，请重试。",
    loading: "正在读取插件设置…",
  ...
  en: {
    ...
    fieldHint: "Industrial order, ash surfaces, and a fluorescent signal accent.",
    fish: "Blue Big Fish",
    fishHint: "Bright cobalt, white surfaces, and playful whale-girl community energy.",
    saving: "Saving…",
