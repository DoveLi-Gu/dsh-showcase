...
const sharedCss = [
  ...
  ".poster{position:relative;width:100%;height:100vh;min-height:44rem;overflow:hidden}",
...
function createFishPoster(data) {
  ...
  return [
    ...
    '<div class="footer mono">', escapeHtml(text.footer), '</div></article>', evidencePageMarkup(data, text), '</body></html>',
  ].join("");
}
